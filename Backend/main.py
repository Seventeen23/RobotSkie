...
HERO_DATA = [
    ...
    {"id": 131, "name": "Ringmaster", "roles": ["Support", "Disabler", "Escape", "Nuker"], "attr": "int"},
    {"id": 145, "name": "Kez", "roles": ["Carry", "Escape", "Disabler"], "attr": "agi"},
    {"id": 155, "name": "Largo", "roles": ["Support", "Disabler", "Durable"], "attr": "str"},
]
